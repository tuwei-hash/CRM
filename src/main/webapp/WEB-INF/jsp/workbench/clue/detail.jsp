...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#aName").keydown(function (event) {
			...
			if (event.keyCode===13){
				...
				$.ajax({
					...
					url:'workbench/clue/getActivityByNameNotBindClue.do',
					data:{
					...
					success:function (data) {
						...
						$.each(data,function (i,a) {
							...
							html += '<tr>';
							html += '<td><input value="'+a.id+'" type="checkbox"/></td>';
							html += '<td>'+a.name+'</td>';
		...
		$("#bind").click(function () {
			...
			var $checked = $("#searchBody input[type=checkbox]:checked");
		...
		$.ajax({
			...
			success:function (data) {
				...
				$.each(data,function (i,a) {
					...
					html += '<td>'+a.endDate+'</td>';
					html += '<td>'+a.owner+'</td>';
					html += '<td><a href="javascript:void(0);" onclick="unBind(\''+a.id+'\')" style="text-decoration: none;"><span class="glyphicon glyphicon-remove"></span>解除关联</a></td>';
					html += '</tr>';
...
<%--							<tr>
				...
				<div class="modal-footer">
					...
					<button id="bind" type="button" class="btn btn-default" data-dismiss="modal">关联</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div style="position: relative; left: 40px; top: -30px;">
		...
		<div style="position: relative; height: 50px; width: 500px;  top: -72px; left: 700px;">
			<button type="button" class="btn btn-default" onclick="window.location.href='workbench/clue/toConvert.do?clueId=${c.id}';"><span class="glyphicon glyphicon-retweet"></span> 转换</button>
