...
<script type="text/javascript">
	...
	function changeIcon(i) {
		...
		//取得当前阶段下标
		var index = i;
		//取得前面正常阶段和后面丢失阶段分界点下标
		var point = "<%=point%>";

		//如果当前阶段的可能性为0，前7个是黑圈，后两个一个红叉，一个黑叉
...
<body>
	...
	<div style="position: relative; left: 40px; top: -50px;">
		...
		<%
			...
			//如果当前阶段可能性为0，前七个阶段一定是黑圈，后两个阶段一定是红圈
			if ("0".equals(currentPossibility)){

				//遍历每一个阶段，按顺序拿到每一个阶段的可能性
				for (int i = 0; i < dvList.size(); i++) {
		...
		<%
			...
			//如果当前阶段不为0，前7个阶段可能是绿圈，绿色标记，黑圈，后两个阶段一定是黑叉
			}else {
